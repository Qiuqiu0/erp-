      ...
      <div class="index">
        ...
        <div class="el-table-div">
          <el-table border
            ...
            <el-table-column prop="batchInvTime"
                             label="入库日期"
                             show-overflow-tooltip>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    conList () {
      ...
      if (localStorage.getItem('selectionedPoNo') != 'undefined') {
        poNo = localStorage.getItem('selectionedPoNo')
      }
      let data = {
