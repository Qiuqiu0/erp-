<template>
  <!-- 公司列表 -->
  <div class="odSoContractPopup" v-if="tipShow">
    <el-dialog
    ...
    >
      <div class="index">
        ...
        <div class="input-div">
          ...
          <div class="dialog-search-div">
            ...
            <el-col :span="5" class="el-col">
              <label>销售合同号</label>
              <el-input v-model="soContractNo" class="el-inputs" size="small" placeholder="请输入"></el-input>
            </el-col>
            <el-col :span="5" class="el-col">
              <label>外部合同号</label>
        ...
        <div class="el-table-div">
          ...
          >
            ...
            <el-table-column prop="soContractNo" label="销售合同号" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="updatedTime" label="修改时间" show-overflow-tooltip>
              <template scope="scope">
      ...
      <div class="button-div2">
        <el-button class="query-button"  @click="tipsSure()" icon="el-icon-check">确 定</el-button>
        <el-button class="query-button" @click="tipsCancle()" icon="el-icon-close">取 消</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    conList() {
      ...
      let params =
        JSON.stringify(this.searchOptions)!= "{}"
          ...
          : {
              ...
              // originCurrencyCode: this.coin.currencyCode
            };
      ...
      params.originCurrencyCode=this.coin.currencyCode
      params.pageNum = this.pageNum;
      params.rows = this.pageSize;
      params.soContractNo = this.soContractNo;
...
function validatasSelectioned(array, keys) {
  //companyId orgId custId originCurrencyCode
