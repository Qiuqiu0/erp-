<template>
  <!-- 公司列表 -->
  <div class="fiGatheringBillPopup" v-if="tipShow">
    <el-dialog
      ...
      <div class="index">
        ...
        <div class="input-div">
          <div>
            ...
            <!-- 票据类型 -->
            <invoice-type-select :disable="disableInvoiceType" :invoiceType.sync="instrumentType"></invoice-type-select>
            <!--公司选择-->
            <compony-select
            ...
            <!-- 客户选择 -->
            <customer-select
              v-show="!searchOptions.payCompanyCode"
              class="el-col el-col-5"
        ...
        <div class="el-table-div">
          ...
          >
            ...
            <el-table-column prop="payCompanyName" label="客户" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column prop="instrumentAmt" label="票据金额" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    conList() {
      ...
      params.instrumentStatus=this.instrumentStatus;
    ...
    searchOptions: {
      handler(val) {
        if (JSON.stringify(val) != "{}") {
          this.instrumentType = val.instrumentType ?val.instrumentType : "";
          this.disableInvoiceType = val.instrumentType ? true : false;
        }
      },
      immediate: true
    }
