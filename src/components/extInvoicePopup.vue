<template>
  <!-- 公司列表 -->
  <div class="extInvoicePopup" v-if="tipShow">
    <el-dialog
      ...
      <div class="index">
        ...
        <div class="input-div">
          ...
          <div class="dialog-search-div">
            <el-col :span="5" class="el-col">
              <label>销售发票号</label>
              <el-input v-model="invoiceCode" class="el-inputs" size="small" placeholder="请输入"></el-input>
            </el-col>
            <el-col :span="5" class="el-col">
              <label>销售合同号</label>
        ...
        <div class="el-table-div">
          ...
          >
            ...
            <el-table-column prop="invoiceCode" label="销售发票号" show-overflow-tooltip></el-table-column>
            <el-table-column prop="extInvoiceCode" label="外部合同号" show-overflow-tooltip></el-table-column>
          </el-table>
          <!--分页background-->
          <el-pagination
      ...
      let params =
        JSON.stringify(this.searchOptions) != "{}"
          ...
          : {
              ...
              orgCode: this.orgCode.branchCode,
