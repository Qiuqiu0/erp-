      ...
      <el-tab-pane label="基本信息" name="basic">
        <div class="input-div">
          <el-row>
            ...
            <el-col :span="5" class="el-col">
              <label>供应商代码</label>
              <el-input v-model="supplierInfo.supplierCode" class="el-inputs" disabled></el-input>
            </el-col>
            <el-col :span="5" class="el-col">
              <label>供应商名称</label>
              <el-input v-model="supplierInfo.supplierName" class="el-inputs" disabled></el-input>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="5" class="el-col">
  ...
  methods: {
    ...
    supplierCreditDetail() {
      CreditApi.supplierCreditList({
        ...
        this.supplierInfo = {
          supplierCode: creditInfo.supplierCode,
          supplierName: creditInfo.supplierName
        }
