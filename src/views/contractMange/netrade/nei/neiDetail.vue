<template>
  <div class="neDetail content-div2">
...
import tabFirst from "@/views/contractMange/netrade/nei/tabFirst.vue";
import tabSecond from "@/views/contractMange/netrade/nei/tabSecond.vue";
import tabThird from "@/views/contractMange/netrade/nei/tabThird.vue";
import tabFourth from "@/views/contractMange/netrade/nei/tabFourth.vue";
import tabFifth from "@/views/contractMange/netrade/nei/tabFifth.vue";
import tabSixth from "@/views/contractMange/netrade/nei/tabSixth.vue";
import tabEight from "@/views/contractMange/netrade/nei/tabEight.vue";
import tabNinth from "@/views/contractMange/netrade/nei/tabNinth.vue";
import tabTenth from "@/views/contractMange/netrade/nei/tabTenth.vue";
