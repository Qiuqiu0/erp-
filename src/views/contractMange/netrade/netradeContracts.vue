<template>
  <div class="netradeContract content-div">
    <el-col class="el-col el-col-btn auto-sibling">
      <div class="button-div">
        ...
        <!-- <el-button icon="el-icon-refresh" @click="go">对比页面</el-button> -->
      </div>
    </el-col>
    <!-- 搜索 -->
    ...
    <div class="button-div auto-sibling">
      ...
      <el-button
        ...
        >收到原件</el-button
      >
      <el-button icon="el-icon-thumb" @click="goTree"  v-if="$actionFlag(`F017`)">生命树</el-button>
...
import ycdxPop from "@/views/contractMange/netrade/ycdxPop.vue";
