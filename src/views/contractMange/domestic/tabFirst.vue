    ...
    <div class="input-div input-div-bor">
      ...
      <div>
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>公司
          </label>
          <el-input v-model="companyName.companyName" :class="errorKey.includes('companyName') ? 'inputRed' : ''" class="el-inputs" placeholder="请选择" disabled></el-input>
        ...
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>部门
          </label>
          <el-input v-model="branchName.branchName" :class="errorKey.includes('branchName') ? 'inputRed' : ''" class="el-inputs" placeholder="请选择" disabled></el-input>
        ...
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>业务员
          </label>
          <el-input v-model="staffName.empName" :class="errorKey.includes('staffName') ? 'inputRed' : ''" class="el-inputs" placeholder="请选择" disabled></el-input>
        ...
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>销售合同号
          </label>
          <el-input v-model="soContractNo" :class="errorKey.includes('soContractNo') ? 'inputRed' : ''" class="el-inputs" disabled placeholder="保存自动生成"></el-input>
        </el-col>
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>销售客户
          </label>
          <el-input v-model="custName.customerName" :class="errorKey.includes('custName') ? 'inputRed' : ''" class="el-inputs" placeholder="请选择" disabled></el-input>
          <span
            class="comicon"
            @click="customerTip"
            v-if="
        ...
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>外部合同号
          </label>
          <el-input v-model="extCode" :class="errorKey.includes('extCode') ? 'inputRed' : ''" class="el-inputs" placeholder="请输入"></el-input>
        </el-col>
        ...
        <el-col :span="5" class="el-col">
          <label>项目名称</label>
          <el-input v-model="projectName.projectName" class="el-inputs" disabled></el-input>
        </el-col>
        <el-col :span="5" class="el-colc el-col-required">
          <label>
            <span class="must-full">*</span>签订日期
          </label>
          <el-date-picker
            style="width:70%;"
            v-model="signTime"
        ...
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>业务币种
          </label>
          <el-input v-model="currencyName" :class="errorKey.includes('currencyName') ? 'inputRed' : ''" class="el-inputs" placeholder="请选择" disabled></el-input>
        ...
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>本位币汇率
          </label>
          <el-input
        ...
        <el-col :span="5" class="el-col">
          <label>含税金额</label>
          <el-input v-model="contractAmtVat" class="el-inputs" disabled placeholder type="number"></el-input>
        </el-col>
        <el-col :span="5" class="el-col">
          <label>统计数量</label>
          <el-input v-model="sumQty" class="el-inputs" disabled placeholder type="number"></el-input>
        </el-col>
        <el-col :span="5" class="el-col el-col-required">
          <label>
            <span class="must-full">*</span>购销方式
          </label>
          <el-select v-model="tradeType" placeholder="请选择" :class="errorKey.includes('tradeType') ? 'inputRed' : ''" :disabled="ycdxType">
            <el-option
        ...
        <el-col :span="5" class="el-colc el-col-required">
          <label>
            <span class="must-full">*</span>合同类型
          </label>
          <el-select
            v-model="contractCat"
            placeholder="请选择"
            :class="errorKey.includes('contractCat') ? 'inputRed' : ''"
            :disabled="$route.query.change ? true : false"
          >
            <el-option
        ...
        <el-col :span="5" class="el-col">
          <label>框架协议号</label>
          <el-input v-model="fwContractNo" class="el-inputs" placeholder="请选择" disabled></el-input>
          <span class="comicon" v-if="fwContractNo" @click="fwContractNo = ``">
            <i class="el-icon-circle-close"></i>
          </span>
          <span class="comicon" v-else @click="agreeTip">
            <i class="el-icon-search"></i>
          </span>
        </el-col>
        <el-col :span="5" class="el-colc el-col-required">
          <label>
            <span class="must-full">*</span>溢短比%
          </label>
          <el-input
    ...
    <div class="input-div input-div-bor bortop0">
      ...
      <div class>
        ...
        >
          ...
          <el-table-column label="行号" prop="parentSoRowno" v-if="isChildrenContract == 0"></el-table-column>
          <el-table-column label="行号" prop="soRowno" v-else></el-table-column>
          <el-table-column prop="goodsCode" label="物料号" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div class="par_rela">
                <el-input v-model="scope.row.goodsCode" placeholder="请选择" disabled></el-input>
                <span
          ...
          <el-table-column prop="goodsName" label="物料名称" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
          ...
          <el-table-column prop="goodsCategoryName" label="物料种类" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div v-if="scope.row.goodsCode == ``">
                <span class="must-full">*</span>
                <el-input
              ...
              <div v-else>{{ scope.row.goodsCategoryName }}</div>
            </template>
          </el-table-column>
          <el-table-column prop="goodsSpec" label="物料规格" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div v-if="scope.row.goodsCode == ``">
                <span class="must-full">*</span>
                <el-input
              ...
              <div v-else>{{ scope.row.goodsSpec }}</div>
            </template>
          </el-table-column>
          <el-table-column prop="itemUnitName" label="基础单位" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div v-if="scope.row.goodsCode == ``">
                <span class="must-full">*</span>
                <el-select
              ...
              <div v-else>{{ scope.row.itemUnitName }}</div>
            </template>
          </el-table-column>
          <el-table-column prop="itemQty" label="数量" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="secUnitName" label="第二单位" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div v-if="scope.row.goodsCode == ``">
                <el-select
              ...
              <div v-else>{{ scope.row.secUnitName }}</div>
            </template>
          </el-table-column>
          <el-table-column prop="secQty" label="第二数量" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <el-input
          ...
          <el-table-column prop="originPrice" label="业务币含税单价" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="unOriginPrice" label="业务币不含税单价" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="originAmt" label="业务币含税金额" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="unOriginAmt" label="业务币不含税金额" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="taxRate" label="增值税率%" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column width="150" show-overflow-tooltip prop="originTaxAmt" label="业务币增值税额">
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
                  v-model="scope.row.originTaxAmt"
          ...
          <el-table-column prop="baseTax" label="本币增值税额" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="basePrice" label="本币含税单价" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="unBasePrice" label="本币不含税单价" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="baseAmt" label="本币含税金额" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
          ...
          <el-table-column prop="unBaseAmt" label="本币不含税金额" width="150" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
                <span class="must-full">*</span>
                <el-input
...
export default {
  ...
  methods: {
    ...
    getDetail() {
      ...
      Bmange.getXx(params)
        .then(res => {
          let red = res.data;
          this.$store.commit(`xsDel`, {
            soContractId: red.soContractId,
            version: red.version
          });
          this.version = red.version;
          this.soContractId = red.soContractId; //合同ID
          this.psContractNo = red.psContractNo; //双边合同好
        ...
        .then(res => {
          ...
          if (this.$route.query.children) {
            ...
            for (const item of this.tableData) {
              let one = Math.random() * (1000 - 1) + 1;
              item.soContractDetailId = ``;
              item.soContractId = ``;
              item.soContractNo = ``;
              item.one = one;
              item.parentSoRowno = item.soRowno;
            }
          }
        })
        .catch();
    ...
    to() {
      ...
      let data = {
        odSoContract: {
          psContractNo: this.psContractNo,
      ...
      //变更合同
      if (this.$route.query.change) {
        data.odSoContractItemsList = [...this.tableData, ...this.delHis];
      }
    ...
    setUp() {
      ...
      this.$confirm("确定删除吗？", {
        ...
        .then(() => {
          ...
          let params = {
            soContractDetailIdList: idSav.join(","),
    ...
    addList() {
      ...
      if (this.$route.query.change) {
        let maxList = [];
        for (const item of this.tableData) {
          maxList.push(item.soRowno);
        }
        let max = Math.max(...maxList);
        data.soRowno = Count.accAdd(max, 10);
      }
        ...
        if (index === 0) {
          ...
          if (!values.every(value => isNaN(value))) {
            sums[index] = values.reduce((prev, curr) => {
              const value = Number(curr);
              if (!isNaN(value)) {
                let res = self.$calculationAmount(prev, curr, "add"); //parseFloat(prev + curr);
                return res;
              } else {
                return prev;
              }
  ...
  watch: {
    ...
    tableData: {
      handler(e) {
        ...
        this.tableData.length &&
          this.$root.Bus.$emit("LXtaxRate", this.tableData[0].taxRate);
        let tol = 0;
        for (const item of this.tableData) {
          tol = Count.accAdd(tol, item.originTaxAmt);
        }
        //销项增值税
        this.$root.Bus.$emit("originTaxAmt", { a: tol, b: `内贸` });
      },
      deep: true
    },
    soContractNo: {
    ...
    contractAmtVat: {
      handler() {
        //销售收入（含税）
        this.$root.Bus.$emit("contractAmtVat", {
          a: this.contractAmtVat,
          b: `内贸`
        });
      }
    },
