<template>
  <div class="createDomestic content-div2">
...
import tabFirst from "@/views/contractMange/domestic/tabFirst.vue";
import tabSecond from "@/views/contractMange/domestic/tabSecond.vue";
import tabThird from "@/views/contractMange/domestic/tabThird.vue";
import tabFourth from "@/views/contractMange/domestic/tabFourth.vue";
import tabFifth from "@/views/contractMange/domestic/tabFifth.vue";
import tabSixth from "@/views/contractMange/domestic/tabSixth.vue";
import tabSeventh from "@/views/contractMange/domestic/tabSeventh.vue";
import tabEight from "@/views/contractMange/domestic/tabEight.vue";
import tabNinth from "@/views/contractMange/domestic/tabNinth.vue";
import tabTenth from "@/views/contractMange/domestic/tabTenth.vue";
...
export default {
  ...
  methods: {
    ...
    goBack() {
      this.$router.push("/index/contractMange/domestic/domesticContracts");
    },
    get(e, o) {
      ...
      switch (o) {
        ...
        case 2:
          //收款方式
          this.getData.odPsContractGatheringFormList = e;
        ...
        case 4:
          ...
          this.getData.odSoCtiPathsFormList = e.odSoCtiPathsList;
          this.getData.odSoTransferTargetFormList = e.odSoTransferTargetList;
        ...
        case 7:
          //销售合同条款
          this.getData.odSoContractTermFormList = e;
