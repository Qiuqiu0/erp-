          ...
          >
            <template slot-scope="scope">
              <div v-for="item in sklxList" :key="item.dict_code">
                <span v-if="item.dict_code == scope.row.gatheringType">{{ item.dict_value }}</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              <div v-for="item in skfsList" :key="item.dict_code">
                <span v-if="item.dict_code == scope.row.gatheringWay">{{ item.dict_value }}</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              <div v-for="item in xyzlxList" :key="item.dict_code">
                <span v-if="item.dict_code == scope.row.creditType">{{ item.dict_value }}</span>
              </div>
            </template>
          </el-table-column>
