    ...
    <div class="input-div input-div-bor bortop0">
      ...
      <div class>
        <el-table border center :data="tableData" class="el-table" @selection-change="handleChange">
          ...
          <el-table-column prop="extCode" label="外部合同号" show-overflow-tooltip width="170"></el-table-column>
          ...
          <el-table-column show-overflow-tooltip prop="remark" label="备注" width="170"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDetailHis() {
      ...
      BAmange.getGl(params)
        .then(res => {
          if(res.data && res.data.length){
          this.tableData = res.data.map(item => {
            item.odPoContractArchive.id = item.id;
            return item.odPoContractArchive;
          });
          }
        })
        .catch();
