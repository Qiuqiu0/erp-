<template>
  <div class="createJktrade content-div2">
...
import tabFirst from "@/views/contractMange/jktrade/tabFirst.vue";
import tabSecond from "@/views/contractMange/jktrade/tabSecond.vue";
import tabThird from "@/views/contractMange/jktrade/tabThird.vue";
import tabFourth from "@/views/contractMange/jktrade/tabFourth.vue";
import tabFifth from "@/views/contractMange/jktrade/tabFifth.vue";
import tabSixth from "@/views/contractMange/jktrade/tabSixth.vue";
import tabEight from "@/views/contractMange/jktrade/tabEight.vue";
import tabNinth from "@/views/contractMange/jktrade/tabNinth.vue";
import tabTenth from "@/views/contractMange/jktrade/tabTenth.vue";
