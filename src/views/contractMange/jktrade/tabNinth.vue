      ...
      <div v-show="activeName2 == 'second'">
        ...
        <div class>
          ...
          >
            ...
            <el-table-column show-overflow-tooltip prop="soContractNo" label="销售合同号"></el-table-column>
            <el-table-column show-overflow-tooltip prop="extCode" label="外部合同号"></el-table-column>
            ...
            <el-table-column show-overflow-tooltip prop="goodsCode" label="物料编号"></el-table-column>
            <el-table-column show-overflow-tooltip prop="goodsName" label="物料名称"></el-table-column>
            <!-- <el-table-column show-overflow-tooltip prop="goodsCat" label="物料大类">
            </el-table-column>-->
            <el-table-column show-overflow-tooltip prop="goodsSpec" label="物料规格"></el-table-column>
            <el-table-column show-overflow-tooltip prop="itemUnitName" label="基础单位"></el-table-column>
            <el-table-column show-overflow-tooltip prop="itemQty" label="数量"></el-table-column>
            ...
            <el-table-column show-overflow-tooltip prop="originPrice" label="含税售价"></el-table-column>
...
import eanList from "@/views/contractMange/CgBEanalyze";
  ...
  watch: {
    ...
    tableData: {
      handler() {
        ...
        //销售收入（含税）
        this.$root.Bus.$emit(`contractAmtVat`, { a: vat, b: `进口` });
        //销项增值税
        this.$root.Bus.$emit(`originTaxAmt`, { a: originTaxAmt, b: `进口` });
      },
      deep: true
    }
  },
