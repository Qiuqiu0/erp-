<template>
  <div class="jkDetail content-div2">
...
import tabFirst from "@/views/contractMange/jktrade/jin/tabFirst.vue";
import tabSecond from "@/views/contractMange/jktrade/jin/tabSecond.vue";
import tabThird from "@/views/contractMange/jktrade/jin/tabThird.vue";
import tabFourth from "@/views/contractMange/jktrade/jin/tabFourth.vue";
import tabFifth from "@/views/contractMange/jktrade/jin/tabFifth.vue";
import tabSixth from "@/views/contractMange/jktrade/jin/tabSixth.vue";
import tabEight from "@/views/contractMange/jktrade/jin/tabEight.vue";
import tabNinth from "@/views/contractMange/jktrade/jin/tabNinth.vue";
import tabTenth from "@/views/contractMange/jktrade/jin/tabTenth.vue";
...
export default {
  ...
  methods: {
    ...
    goBack() {
      this.$router.push("/index/contractMange/jktrade/jktradecontract");
    },
    get(e, o) {
      switch (o) {
        case 1:
