<template>
  <div class="createExport content-div2">
    ...
    <el-tabs class="el-tabs" v-model="activeName2" type="card" @tab-click="handleClick" >
      <el-tab-pane label="合同信息" name="first" ></el-tab-pane>
...
import tabFirst from "@/views/contractMange/export/tabFirst.vue";
import tabSecond from "@/views/contractMange/export/tabSecond.vue";
import tabThird from "@/views/contractMange/export/tabThird.vue";
import tabFourth from "@/views/contractMange/export/tabFourth.vue";
import tabFifth from "@/views/contractMange/export/tabFifth.vue";
import tabSixth from "@/views/contractMange/export/tabSixth.vue";
import tabSeventh from "@/views/contractMange/export/tabSeventh.vue";
import tabEight from "@/views/contractMange/export/tabEight.vue";
import tabNinth from "@/views/contractMange/export/tabNinth.vue";
import tabTenth from "@/views/contractMange/export/tabTenth.vue";
