      ...
      <div>
        ...
        <el-col :span="5" class="el-col el-col-required">
          ...
          <el-input
            ...
            class="el-inputs"
            :class="errorKey.includes('soContractNo') ? 'inputRed' : ''"
            disabled
            placeholder="保存自动生成"
          ></el-input>
        </el-col>
        <el-col :span="5" class="el-col el-col-required">
          ...
          <el-input
            ...
            class="el-inputs"
            :class="errorKey.includes('custName') ? 'inputRed' : ''"
            placeholder="请选择"
            disabled
          ></el-input>
          <span
        ...
        <el-col :span="5" class="el-colc el-col-required">
          ...
          <el-select v-model="contractCat" :class="errorKey.includes('contractCat') ? 'inputRed' : ''" placeholder="请选择" disabled>
            <el-option
        ...
        <!-- <el-col :span="5" class="el-colc">
          <label>溢短比%</label>
          <el-input v-model="overShortageRate" class="el-inputs" placeholder="请输入"></el-input>
        </el-col>-->
...
export default {
  ...
  created() {
    ...
    if (this.$route.query.children) this.getNum();
  },
  mounted() {
  ...
  methods: {
    ...
    getDetail() {
      ...
      Bmange.getXx(params)
        .then(res => {
          ...
          this.$root.Bus.$emit("companyName", this.companyName);
    ...
    tipsSure(e) {
      this.componyShow = false;
      this.companyName = e;
      // this.currencyList(e.baseCurrencyCode);
  ...
  watch: {
    ...
    tableData: {
      handler(e) {
        ...
        //销项增值税
        this.$root.Bus.$emit("originTaxAmt", { a: tol, b: `出口` });
      },
      deep: true
    },
    currencyRate: {
