  ...
  watch: {
    ...
    tableData: {
      handler() {
        ...
        //税额
        this.$root.Bus.$emit(`taxAmt`, { a: rol, b: `出口` });
        //采购货价（含税）
        this.$root.Bus.$emit(`vat`, { a: vat, b: `出口` });
      },
      deep: true
    }
  },
