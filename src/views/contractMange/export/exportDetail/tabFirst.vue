  ...
  <div class="tabFirst content-div2 contract_css_link">
    ...
    <div class="input-div input-div-bor">
      ...
      <div>
        ...
        <!-- <el-col :span="5" class="el-colc">
          <label>溢短比%</label>
          <el-input v-model="overShortageRate" class="el-inputs" placeholder=""></el-input>
        </el-col>-->
        ...
        if (index === 0) {
          ...
          if (!values.every(value => isNaN(value))) {
            sums[index] = values.reduce((prev, curr) => {
              ...
              if (!isNaN(value)) {
                let res = Count.accAdd(Number(prev) + Number(curr));
                return res;
              } else {
                return prev;
              }
