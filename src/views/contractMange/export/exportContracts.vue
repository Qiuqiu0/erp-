<template>
  <div class="exportContract content-div">
    ...
    <div class="button-div auto-sibling">
      ...
      <el-button
        ...
        >以采定销</el-button
      >
      <!-- <el-button icon="el-icon-check" @click="setUp(3)">禁用</el-button>
      <el-button icon="el-icon-check" @click="setUp(4)">启用</el-button>-->
      <el-button
        icon="el-icon-download"
...
const AllSearch = [
  ...
  { key: "contractEndDate", label: "有效日期", checked: true },
...
export default {
  ...
  created() {
    ...
    if (data.contractEndDateBegin) {
      this.contractEndDate[0] = data.contractEndDateBegin;
      this.contractEndDate[1] = data.contractEndDateEnd;
    }
  ...
  methods: {
    ...
    List() {
      ...
      let params = {
        ...
        bbCustomerBaseList: this.customer,
        extCode: this.extCode,
        projectCode: this.project.projectCode,
        projectName: this.project.projectName,
        signTimeBegin: this.signTime[0],
        signTimeEnd: this.signTime[1],
        contractEndDateBegin: this.contractEndDate[0],
        contractEndDateEnd: this.contractEndDate[1],
        signPlace: this.signPlace,
        createdTimeBegin: this.createdTime[0],
    ...
    setUp(e, children) {
      ...
      if (children == 1) {
        ...
        //默认出口
        let path = `/index/contractMange/export/createExport`;
        this.$router.push({
          path: path,
      ...
      if (e == 1) {
        ...
        //默认出口
        let path = `/index/contractMange/export/exportDetail`;
        this.$router.push({
          path: path,
          query: { id: this.selectioned[0].soContractId },
        });
