    ...
    <el-form disabled>
      ...
      <div class="input-div input-div-bor">
        ...
        <div>
          ...
          <el-col :span="5" class="el-colc">
            <label>提货方式</label>
            <el-select v-model="pickupType" placeholder="">
              <el-option
        ...
        <div class="martop_10">
          ...
          >
            ...
            >
              ...
              <div>
                <span class="must-full">*</span>
                <el-input v-model="scope.row.unOriginPrice" placeholder="请输入内容" disabled></el-input>
              </div>
            </template> -->
            </el-table-column>
            <el-table-column
            ...
            >
              ...
              <div>
                <span class="must-full">*</span>
                <el-input v-model="scope.row.unoriginAmt" placeholder="请输入内容" disabled></el-input>
              </div>
            </template> -->
            </el-table-column>
            <el-table-column
            ...
            >
              ...
              <div>
                <span class="must-full">*</span>
                <el-input v-model="scope.row.taxRate" @input="taxRateCh(scope.row, scope.$index)" placeholder="请输入内容"></el-input>
              </div>
            </template> -->
            </el-table-column>
            <el-table-column
            ...
            >
              ...
              <div>
                <span class="must-full">*</span>
                <el-input v-model="scope.row.taxAmt" @input="taxAmtCh(scope.row, scope.$index)" placeholder="请输入内容"></el-input>
              </div>
            </template> -->
            </el-table-column>
            <el-table-column
          ...
          >
            ...
            >
              <template slot-scope="scope">
                ...
                <!-- <div>
                <el-select v-model="scope.row.leaveTransferMode" placeholder="">
                  <el-option
                    v-for="item in ysfsList"
                    :key="item.dict_code"
                    :label="item.dict_value"
            ...
            >
              <!-- <template slot-scope="scope">
              <div>
                <el-input v-model="scope.row.transferTarget" placeholder="请输入内容"></el-input>
              </div>
            </template> -->
            </el-table-column>
            <el-table-column
            ...
            >
              <!-- <template slot-scope="scope">
              <div>
                <el-input v-model="scope.row.transferPlanMan" placeholder="请输入内容"></el-input>
              </div>
            </template> -->
            </el-table-column>
            <el-table-column
            ...
            >
              <!-- <template slot-scope="scope">
              <div>
                <el-input v-model="scope.row.transferExcutor" placeholder="请输入内容"></el-input>
              </div>
            </template> -->
            </el-table-column>
            <el-table-column
            ...
            >
              <!-- <template slot-scope="scope">
              <div>
                <el-input v-model="scope.row.transferNote" placeholder="请输入内容"></el-input>
              </div>
            </template> -->
            </el-table-column>
          </el-table>
