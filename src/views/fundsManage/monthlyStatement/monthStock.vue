    ...
    <div id="settlementSheet" class="content-div">
        ...
        <div class="input-div auto-sibling">
            ...
            <div class="search-div">
                ...
                <el-col :span="5" class="el-col">
                    <label>期间</label>
                    <el-date-picker value-format="yyyy-MM" v-model="accountingMonth" type="monthrange" size="mini"
        ...
        <div class="el-table-div" v-auto>
            <el-table border center ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%"
                ...
                <el-table-column prop="accountingMonth" width="170" label="期间" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="companyName" width="170" label="公司" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="orgName" label="部门" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="skuCode" label="物料号" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="skuName" label="物料名称" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="categoryName" label="物料大类" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="propertyInfo" label="规格" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="warehouseName" label="仓库" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="batchCode" label="批次号" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="invQtyS" label="期初库存数量" width="100" show-overflow-tooltip>
                    <template slot-scope="scope">
                        <span>{{$numberToFixed(scope.row.invQtyS, 3)}}</span>
                    </template>
                </el-table-column>
                 <el-table-column prop="batchInvQtyS" label="进货数量" width="100" show-overflow-tooltip>
                    <template slot-scope="scope">
                        <span>{{$numberToFixed(scope.row.batchInvQtyS, 3)}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="outInvQtyS" label="出货数量" width="100" show-overflow-tooltip>
                    <template slot-scope="scope">
                        <span>{{$numberToFixed(scope.row.outInvQtyS, 3)}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="firstUnit" label="基础单位" width="100" show-overflow-tooltip>
                </el-table-column>
                <el-table-column prop="reservedQtyS" label="结存数量" width="100" show-overflow-tooltip>
                    <template slot-scope="scope">
                        <span>{{$numberToFixed(scope.row.reservedQtyS, 3)}}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="batchInvAmt" :formatter="$moneyFormat" label="结存金额" width="100" show-overflow-tooltip>
                </el-table-column>
            </el-table>
            <!-- 分页 -->
            <div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clearmsg() {//重置
                this.companyName = this.branchName = this.warehouseName = this.batchCode = this.mattermsg= "";
