<template>
  <div class="table-div">
    <el-form  style="height:100%;" :disabled="flag!=1">
      ...
      <el-table
        ...
        v-loading="loading"
      >
        <el-table-column type="selection" width="40" :disabled="flag!=1"></el-table-column>
        ...
        <el-table-column prop="paymentCode" label="付款单号">
           <template slot-scope="scope">
            <div v-if="scope.row.edit" class="tip-select">
