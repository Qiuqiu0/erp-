...
<template>
  <div id="salesLink">
    <el-dialog title="销售环节" :visible.sync="isShow" :show-close="false" :before-close="cancel" width="1100px">
      <div class="index">
        ...
        <div class="input-div" style="padding-left:0">
          ...
          <div class="dialog-search-div">
            ...
            <el-col :span="5" class="el-col">
              <label class="text_too_long_popup">销售合同号</label>
              <el-input v-model="soContractCode" class="el-inputs"></el-input>
            </el-col>
            <el-col :span="5" class="el-col">
          ...
          <!--客户弹窗-->
          <customer-select v-if="customerShow" :tipShow="customerShow" @customerCancle="customerCancel" @customerSure="customerSure"></customer-select>
          <!--项目号弹窗-->
        ...
        <div>
          <el-table
            ...
            <el-table-column prop="contractNo" label="销售合同号" min-width="150" show-overflow-tooltip></el-table-column>
            ...
            <!-- <el-table-column prop="stockInOutCode" label="出库单号" min-width="150" show-overflow-tooltip></el-table-column> -->
            <el-table-column label="签订日期" min-width="100" show-overflow-tooltip>
              <template slot-scope="scope">
                <span>{{scope.row.signDate | time2Date}}</span>
              </template>
            </el-table-column>
            <el-table-column prop="personName" label="客户" min-width="180" show-overflow-tooltip></el-table-column>
  ...
  methods: {
    ...
    queryData() {
      let params = {
        ...
        contactNo: this.soContractCode,
        extContactNo: this.extContractCode,
        stockInOutCode: this.outputCode,
      ...
      this.loading = true;
      CostApi.salesLinkList2(params).then(res => {
        this.loading = false;
        if (res.code == "success") {
