<template>
  ...
  <div class="billOfLading content-div">
    ...
    <div ref="print" style="margin:0 auto;margin-top:20px;">
        <h3 style="text-align:center;margin:20px;font-size:16px;">费用结算单</h3>
        <table class="table table-srtiped table-bordered" align="center" valign="center">
            <tr class="text-left">
             ...
             <tr class="text-left">
                <td class="column">费用编号</td>
                <td colspan="8" class="value">{{costDocNo}}</td>
            </tr>
             <tr class="text-left">
             ...
             <tr class="text-left">
                <td  class="column">财务账期</td>
                <td colspan="8"  class="value">{{warrantMonth}}</td>
            </tr>
             <tr class="text-left">
            ...
            <tr class="text-center">
                ...
                <td class="column">结算金额（不含税）</td>
                <td class="column">结算金额（含税）</td>
            </tr>
