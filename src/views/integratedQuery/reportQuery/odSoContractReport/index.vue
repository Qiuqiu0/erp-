  ...
  <div class="odSoContractReport">
    ...
    <div class="el-table-div" v-auto>
      ...
      >
        ...
        <el-table-column prop="soContractNo" width="120" show-overflow-tooltip label="销售合同号"></el-table-column>
        ...
        <el-table-column prop="contractCat" show-overflow-tooltip label="合同类型">
            <template scope="scope">
              <span v-for="(item, index) in contractCatList" :key="index">
        ...
        <el-table-column prop="custName" width="170" show-overflow-tooltip label="客户"></el-table-column>
        ...
        <el-table-column prop="sumQty" width="180" show-overflow-tooltip label="数量">
          <template slot-scope="scope">
        ...
        <!-- <el-table-column prop="overShortageAmt" width="150" show-overflow-tooltip label="溢短金额" >
            <template slot-scope="scope">
            <div class="content_right">
                  <span>{{$moneyFormat({},{},scope.row.overShortageAmt)}}</span>
            </div>
            </template>
        </el-table-column> -->
        <el-table-column prop="contractAmtVat"  width="150" show-overflow-tooltip label="业务币含税金额">
          <template slot-scope="scope">
            <div class="content_right">
                  <span>{{$moneyFormat({},{},scope.row.contractAmtVat)}}</span>
            </div>
            </template>
        </el-table-column>
        <el-table-column prop="itemQty" width="150" show-overflow-tooltip label="出库数量">
          <template slot-scope="scope">
            <div class="content_right">
        ...
        <el-table-column prop="secQty" width="150" show-overflow-tooltip label="出库第二数量">
            <template slot-scope="scope">
              <div class="content_right">
        ...
        <!-- <el-table-column prop="createdTime" width="170" show-overflow-tooltip label="创建时间">
          <template slot-scope="scope">
...
import {
  getOdSoContractReportList,
  getOdSoContractTotal,
  exportOdSoContractExecutiveCondition
} from "@/api/reportQuery/report";
import { contractCatObj, contractStatusObj } from "../../dictionary";
...
export default {
  ...
  methods: {
    ...
    queryData() {
      ...
      this.loading = true;
      getOdSoContractReportList(this.$queryFilter(params)).then(res => {
        if (res.code === "success") {
    ...
    getTotal() {
      ...
      this.loading = true;
      getOdSoContractTotal(this.$queryFilter(params)).then(res => {
        if (res.code === "success") {
    ...
    download(){
      ...
      exportOdSoContractExecutiveCondition(this.$queryFilter(data)).then(res=>{
        if(res.code=="fail"){
