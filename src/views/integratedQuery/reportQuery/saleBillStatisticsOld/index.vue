<template>
  <div class="saleBillStatisticsOld">
    ...
    <div class="el-table-div" v-auto>
      ...
      >
        ...
        <el-table-column prop="saleCostAmt" width="170" 
          :formatter="$moneyFormat"  
          show-overflow-tooltip 
          label="月加权销售成本">
        </el-table-column>
        <el-table-column prop="mainCodeAmt" width="200" :formatter="$moneyFormat"  show-overflow-tooltip label="进主营业务成本金额"></el-table-column>
        <el-table-column prop="unMainCodeAmt" width="200" :formatter="$moneyFormat"  show-overflow-tooltip label="非本月主营业务成本分摊金额"></el-table-column>
        <el-table-column prop="cuMainCodeAmt" width="180" :formatter="$moneyFormat"  show-overflow-tooltip label="当月主营业务成本分摊"></el-table-column>
        ...
        <el-table-column prop="warrantPostCode" width="140" show-overflow-tooltip label="开票财务凭证号"></el-table-column>
...
import { getSaleBillStatistics,getSaleBillReportTotal,exportBillStatistics } from "@/api/reportQuery/report";
  ...
  // this.loading = true;
    ...
    exportExcel() {
      ...
      if(params.hasOwnProperty("companyCode") && params.hasOwnProperty("accoutingMonthBeginStr")){
        ...
        exportBillStatistics(this.$queryFilter(params)).then(res => {
          if (res.status === 200) {
            if(res.code=="fail"){
