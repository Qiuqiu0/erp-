...
const List = data => {
  return serviceJson({
    url: suffix + "/soContract/getOdSoContractListV2.do",
    method: "post",
    data
  });
};
...
const soList = data => {
  return serviceJson({
    url: suffix + "/soContract/getOdSoSimulateList.do",
    method: "post",
    data
  });
};
...
const audCon2 = data => {
  return serviceJson({
    url: suffix + "/soContract/auditOdSoContract2.do",
    method: "post",
    data
  });
};
...
const getXx = data => {
  return service({
    url: suffix + "/soContract/getOdSoContract.do",
    method: "post",
    data
  });
};
...
const getSk = data => {
  return serviceJson({
    url: suffix + "/soContract/getOdPsContractGatheringList.do",
    method: "post",
    data
  });
};
...
const getYsxx = data => {
  return service({
    url: suffix + "/soContract/getOdSoContractTransferInfo.do",
    method: "post",
    data
  });
};
...
const getLj = data => {
  return serviceJson({
    url: suffix + "/soContract/getOdSoCtiPathsList.do",
    method: "post",
    data
  });
};
...
const getJh = data => {
  return serviceJson({
    url: suffix + "/soContract/getOdSoTransferTargetList.do",
    method: "post",
    data
  });
};
...
const getTk = data => {
  return serviceJson({
    url: suffix + "/soContract/getOdSoContractTermList.do",
    method: "post",
    data
  });
};
...
const getykWl = data => {
  return serviceJson({
    url: suffix + "/soContract/getSoContractProfileSimulateDetailList.do",
    method: "post",
    data
  });
};
...
//双签
const doubleCheckOdSoContract = data => {
  return serviceJson({
    url: suffix + "/soContract/doubleCheckOdSoContract.do",
    method: "post",
    data
  });
};
...
const haveReceiveOrginCopy = data => {
  return serviceJson({
    url: suffix + "/soContract/haveReceiveOrginCopy.do",
    method: "post",
    data
  });
};
